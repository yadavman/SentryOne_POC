...
namespace WebFormIntelliTest.Util
{
    ...
    public class Issue
    {
        ...
        public long CustomerId
        {
            ...
            set
            {
                Customer = provider.GetContacts().Find(contact => contact.Id == value);
            }
        }
    ...
    public  class DataProvider
    {
        ...
        public  List<Issue> GetIssues()
        {
         ...
         void UpdateIssues(List<Issue> list)
        {
    ...
    public  class SchedulerLabelsHelper
    {
        private  List<SchedulerLabel> items;

         SchedulerLabelsHelper()
        {
        ...
        public  List<SchedulerLabel> GetItems()
        {
            return items;
        }
    }
    ...
    public class AppointmentDataSourceHelper
    {
        public AppointmentDataSourceHelper()
        {
         ...
         List<SchedulerAppointment> GetAppointments()
        {
         ...
         void UpdateAppointments(List<SchedulerAppointment> list)
        {
            HttpContext.Current.Session["SchedulerAppointments"] = list;
        }

        public  List<SchedulerAppointment> SelectMethodHandler()
        {
            return GetAppointments();
        }

        private  List<SchedulerAppointment> GenerateAppointments()
        {
            ...
            for (int i = 0; i < dataProvider.GetContacts().Count; i++)
            {
                ...
                appointment.EventType = 10; // Represents the appointment which serves as the pattern for the other recurring appointments
                appointment.LabelId = 213; // Birthday label
                appointment.ResourceId = 1234;
            ...
            for (int i = -100; i < 100; i++)
            {
                ...
                appointment.EventType = 10; // Represents a standard (non-recurring) appointment
                appointment.LabelId = random.Next(1, 4);
                appointment.ResourceId = random.Next(1, 1234);
        ...
        public  object InsertMethodHandler(SchedulerAppointment newAppointment)
        {
        ...
        public  void DeleteMethodHandler(SchedulerAppointment deletedAppointment)
        {
            List<SchedulerAppointment> list = GetAppointments();
        ...
        public  void UpdateMethodHandler(SchedulerAppointment updatedAppointment)
        {
            List<SchedulerAppointment> list = GetAppointments();
    ...
    {
        private  List<SchedulerResource> items;

         ResourceDataSourceHelper()
        {
        ...
        public  List<SchedulerResource> GetItems()
        {
            return GetItems(null);
        }

        public  List<SchedulerResource> GetItems(List<long> ids)
        {
            if (ids == null)
                return items;
