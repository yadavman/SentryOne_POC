...
/// <summary>
/// Summary description for Doner_regDLL
/// </summary>
namespace WebFormIntelliTest
{
    public class Doner_regDLL
    {
        ...
        public void insert(Doner_regBLL objectBLL)
        {
            ...
            {
                int var = 0;
                SqlCommand cmd = new SqlCommand("insert_doner", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@d_user_name", objectBLL.D_user_name);
                ...
                cmd.Parameters.AddWithValue("@d_user_id", objectBLL.D_user_id);
                cmd.Parameters.AddWithValue("@d_password", objectBLL.D_password);
